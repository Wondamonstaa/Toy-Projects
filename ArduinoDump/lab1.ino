...
// 4- Assumptions - I strictly followed the provided instructions to compelte this lab assignment. We should pay attention to positive (Longer pin) and negative (Shorter pin) charges, connect wires strictly at the described position to make sure we do not damage uno.
